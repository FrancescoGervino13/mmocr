...
def det_rec(image) :
    """
    Detection and recognition of text from robot's images.
    
    image: image from robot's camera in cv format.

    Returns: a list containing the recognised texts and the respective bounding boxes.  
    """
    class TextInImage:
        def __init__(self):
